...
function TrainingModal({ onClose }: { onClose: () => void }) {
  ...
  const [funder, setFunder] = useState<'individual' | 'corporate' | 'unsure' | null>(null);
  ...
  return (
    <>
      ...
      >
        {/* Modal shell */}
        <div
          className="relative w-full max-w-[880px] bg-[#0D0D0D] shadow-[0_30px_90px_rgba(0,0,0,0.9)] animate-modalIn flex flex-col md:flex-row overflow-hidden"
          style={{ border: '1px solid #2a2a2a' }}
        >

          {/* ══ LEFT PANEL ══ */}
          <div
            className="md:w-[40%] flex-shrink-0 relative flex flex-col justify-between p-8 overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="inline-flex items-center gap-2 mb-5">
                <svg className="w-3.5 h-3.5 text-[#C8A96E] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                </svg>
                <span className="font-['Syne'] text-[10px] font-bold tracking-[0.2em] uppercase text-[#C8A96E]">
                  Limited Availability
                </span>
              </div>

              {/* Headline */}
              <h2 className="font-['Bebas_Neue'] text-[2.1rem] leading-[0.92] text-[#F5F0E8] mb-3">
                APRIL 2026 COHORT —{' '}
                <span style={{ WebkitTextStroke: '1.5px #C8A96E', color: 'transparent' }}>
                  3 SEATS
                </span>{' '}
                <span className="text-[#C8A96E]">REMAINING</span>
              </h2>

              <p className="font-['Syne'] text-[11px] text-[#8a8580] tracking-wide leading-relaxed">
                Individual certification cohort closes when full. Corporate slots are assessed and confirmed on a rolling basis.{' '}
                <span className="text-[#C8C2B8]">Don't wait for the next cycle.</span>
              </p>

              {/* Urgency bar */}
              <div className="mt-4 border border-[#7a1a1a]/60 bg-[#7a1a1a]/10 px-3 py-2 flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-red-500 flex-shrink-0" style={{ animation: 'pulse 1.5s infinite' }} />
                <span className="font-['Syne'] text-[10px] font-bold tracking-[0.12em] uppercase text-red-400">
            ...
            <div className="relative z-10 mt-7">
              <p className="font-['Syne'] text-[9px] font-bold tracking-[0.2em] uppercase text-[#555] mb-3">
            ...
            {/* Proof stats */}
            <div className="relative z-10 mt-6 flex flex-col gap-2.5 border-t border-[#2a2a2a] pt-5">
              {[
                ...
                <div key={stat} className="flex items-center gap-3">
                  <span className="font-['Bebas_Neue'] text-lg text-[#C8A96E] leading-none w-20 flex-shrink-0">{stat}</span>
                  <span className="font-['Syne'] text-[10px] text-[#8a8580] uppercase tracking-[0.1em]">{label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex-1 p-8 relative">
            ...
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center gap-4 py-12">
                <div className="w-14 h-14 border-2 border-[#C8A96E] flex items-center justify-center">
                  <svg className="w-6 h-6 text-[#C8A96E]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <p className="font-['Bebas_Neue'] text-2xl text-[#F5F0E8]">Seat Reserved!</p>
                <p className="font-['Syne'] text-xs text-[#8a8580]">Coach Ezra will confirm your spot within 24 hours.</p>
              </div>
            ) : (
              <>
                <p className="font-['Syne'] text-[10px] font-bold tracking-[0.15em] uppercase text-[#C8A96E] mb-0.5">
                  EK Capital Group · April 2026
                </p>
                <h3 className="font-['Syne'] text-lg font-bold text-[#F5F0E8] mb-0.5">
                  Secure Your Training Seat
                </h3>
                <p className="font-['Syne'] text-[11px] text-[#8a8580] mb-5">
                  EK12PS™ Sales Certification Program · Kigali, Rwanda
                </p>

                {/* Who will fund */}
                <div className="mb-4">
                  <label className="font-['Syne'] text-[10px] font-bold tracking-[0.12em] uppercase text-[#C8C2B8] mb-2 block">
                  ...
                  <div className="flex gap-2">
                    {([
                      ...
                      <button
                        ...
                        className={`flex-1 py-2.5 font-['Syne'] text-[11px] font-bold tracking-wide uppercase border transition-all duration-150 cursor-pointer ${
                          funder === key
                ...
                <form 
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="font-['Syne'] text-[10px] font-bold tracking-[0.12em] uppercase text-[#C8C2B8] mb-1.5 block">
                        * Full Name
                      </label>
                      <input
                        name="fullName"
                        required type="text" placeholder="Amara Diallo"
                        className="w-full bg-transparent border border-[#2a2a2a] text-[#F5F0E8] font-['Syne'] text-xs px-3 py-2.5 outline-none placeholder-[#3a3a3a] focus:border-[#C8A96E] transition-colors duration-150"
                      />
                    </div>
                    <div>
                      <label className="font-['Syne'] text-[10px] font-bold tracking-[0.12em] uppercase text-[#C8C2B8] mb-1.5 block">
                      ...
                      <input type="hidden" name="_subject" value="New EK Training Seat Request" />
                      <input
                         name="email"
                        required type="email" placeholder="me@company.com"
                        className="w-full bg-transparent border border-[#2a2a2a] text-[#F5F0E8] font-['Syne'] text-xs px-3 py-2.5 outline-none placeholder-[#3a3a3a] focus:border-[#C8A96E] transition-colors duration-150"
                      />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <div className="flex">
                        <span className="bg-[#111] border border-r-0 border-[#2a2a2a] px-2.5 py-2.5 font-['Syne'] text-[10px] text-[#555] flex items-center flex-shrink-0">
                          RW +250
                        </span>
                        <input
                          name="phone"
                          required type="tel" placeholder="790 000 000"
                          className="flex-1 min-w-0 bg-transparent border border-[#2a2a2a] text-[#F5F0E8] font-['Syne'] text-xs px-3 py-2.5 outline-none placeholder-[#3a3a3a] focus:border-[#C8A96E] transition-colors duration-150"
                        />
                      </div>
                    </div>
                    <div>
                      ...
                      <input
                        name="jobTitle"
                        required type="text" placeholder="Sales Director"
                        className="w-full bg-transparent border border-[#2a2a2a] text-[#F5F0E8] font-['Syne'] text-xs px-3 py-2.5 outline-none placeholder-[#3a3a3a] focus:border-[#C8A96E] transition-colors duration-150"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      required
                      name="programType"
                      className="w-full bg-[#111] border border-[#2a2a2a] text-[#C8C2B8] font-['Syne'] text-xs px-3 py-2.5 outline-none focus:border-[#C8A96E] transition-colors duration-150 cursor-pointer"
                    >
                      <option value="">Please select…</option>
                      <option value="individual">Individual Certification (EK12PS™)</option>
                      <option value="corporate">Corporate Team Training</option>
                      <option value="both">Both — Individual + Corporate</option>
                    </select>
                  </div>

                  <p className="font-['Syne'] text-[10px] text-[#444] leading-relaxed">
                    By submitting your details you agree to be contacted by EK Capital Group to confirm your enrolment.
                  </p>

                  <button
                    type="submit"
                    className="w-full bg-[#C8A96E] text-black font-['Syne'] font-bold text-xs tracking-[0.15em] uppercase py-3.5 transition-all duration-200 hover:bg-[#E8C98A] hover:shadow-[0_8px_30px_rgba(200,169,110,0.3)] hover:-translate-y-0.5 cursor-pointer border-none"
                  >
                    SECURE MY SEAT NOW →
                  </button>
                </form>
    ...
    <>
      ...
      >
        ...
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background: 'radial-gradient(ellipse 80% 60% at 65% 50%, rgba(200,169,110,0.07) 0%, transparent 70%)',
          }}
        />

        <div className="relative z-10 max-w-3xl animate-fadeInUp">
          <div className="inline-flex items-center gap-2.5 border border-[#C8A96E] text-[#C8A96E] px-4 py-2 mb-8">
            <span className="w-1.5 h-1.5 bg-[#C8A96E] rounded-full" style={{ animation: 'pulse 2s infinite' }} />
            <span className="font-['Syne'] text-xs font-bold tracking-[0.15em] uppercase">
              Kigali, Rwanda · Pan-African Sales Authority
            </span>
          </div>
          ...
          <h1 className="font-['Bebas_Neue'] text-[clamp(4rem,10vw,9rem)] leading-[0.88] mb-6 text-[#F5F0E8]">
            ...
            <br />
            ISN&apos;T{' '}
            <span className="inline-block" style={{ WebkitTextStroke: '2px #C8A96E', color: 'transparent' }}>
              CLOSING
            </span>
            .
            <br />
          ...
          <p className="text-lg text-[#C8C2B8] max-w-[540px] mb-12 leading-relaxed">
            EK Capital Group builds{' '}
            <strong className="text-[#F5F0E8] font-medium">revenue-generating sales machines</strong>{' '}
            for African companies. From corporate team transformation to individual sales
            certification — we train in real markets, solve real problems, and deliver
            measurable results.{' '}
            <strong className="text-[#F5F0E8] font-medium">Not theory. Revenue.</strong>
          ...
          <div className="flex flex-wrap gap-10 border-t border-[#222222] pt-8">
            {[
              ...
              { stat: 'EKPCS™', label: "Africa's Sales\nCertification Standard" },
            ].map(({ stat, label }) => (
              <div key={stat}>
                <div className="font-['Bebas_Neue'] text-4xl text-[#C8A96E] leading-none">{stat}</div>
                <div className="text-xs text-[#C8C2B8] font-['Syne'] font-semibold tracking-[0.08em] uppercase mt-2 whitespace-pre-line">{label}</div>
              </div>
            ))}
          </div>
        </div>
